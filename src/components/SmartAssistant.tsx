...
export default function SmartAssistant() {
  const [messages, setMessages] = useState<ChatMessage[]>([
    {
      role: 'assistant',
      content: 'Hello! I am the VoteIQ Assistant. I can help you understand the election process, how to register, and how to cast your vote. What would you like to know?',
      timestamp: Date.now()
    }
  ]);
  ...
  return (
    <div className="bg-white/80 dark:bg-gray-900/80 backdrop-blur-md rounded-2xl shadow-2xl border border-white/20 dark:border-gray-700/30 flex flex-col h-[500px] overflow-hidden transition-all duration-300">
      ...
      <div ref={chatContainerRef} className="flex-1 overflow-y-auto p-4 space-y-4 bg-gray-50/50 dark:bg-gray-900/50 scroll-smooth">
